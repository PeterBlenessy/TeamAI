<template>
    <div v-for="message in filteredMessages" :key="message.timestamp" scroll @mouseover="hoveredTimestamp = message.timestamp" @mouseleave="hoveredTimestamp = ''">
            ...
            <q-item top dense>
                ...
                <q-item-section avatar top>
                    <q-avatar v-if="message.role == 'user'" size="xl">
                        ...
                        <q-icon v-else rounded size="xl" :name="mdiAccountCircle" :color="iconColor" />
                    </q-avatar>
                                        ...
                                        <q-card flat square :class="$q.dark.isActive ? 'bg-grey-10' : 'bg-grey-4'">
                                            ...
                                            <q-card-section horizontal>
                                                ...
                                                <q-card-actions vertical class="justify-around">
                                                    <q-btn size="sm" flat dense padding="xs" :icon="mdiExportVariant"
                                                    ...
                                                    <q-btn size="sm" flat dense padding="xs" :icon="mdiDeleteOutline"
                                                        :color="iconColor"
                ...
                <q-item-section side top style="width: 100px; min-height: 55px">
                    <div class="q-gutter-xs" v-if="hoveredTimestamp == message.timestamp">
                        <div class="column items-end">
                            <div class="col">
                                <q-btn v-if="message.object != 'image'" size="sm" flat dense :icon="mdiContentCopy"
                                ...
                                <q-btn v-if="message.object != 'image'" size="sm" flat dense :icon="mdiExportVariant"
                        ...
                        <div class="column items-end">
                            <div class="col">
                                <q-btn v-if="message.role != 'user' && message.object != 'image'" size="sm" flat dense
                                    color="iconColor" :icon="mdiPlayCircleOutline"
        ...
        $t("messages.tooltip.speak") }}
                                ...
                                <q-btn v-if="message.role != 'user'" size="sm" flat dense :icon="mdiInformationOutline"
...
// Rest of your existing functions converted to const declarations
...
// Share message content via 'navigator.share' API, the native sharing mechanism.
...
const deleteMessage = (timestamp, role) => { 
    teamsStore.deleteMessage(timestamp, role); 
    shouldScroll = false; 
};
const deleteChoice = (timestamp, role, index) => {
